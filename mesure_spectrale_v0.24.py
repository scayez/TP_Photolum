...
class MyWindow(QtWidgets.QMainWindow, Ui_MainWindow):   
    ...
    def __init__(self):     
        ...
        self.doubleSpinBox_pas.valueChanged.connect(self.choix_pas)
        self.pas = 1
        ...
        self.pas = self.doubleSpinBox_pas.value()
    ...
    def demarrer(self):
        ...
        self.doubleSpinBox_pas.setEnabled(False)
        self.label_sauvegarde.hide()
    ...
    def on_measurement_done(self,donnees):
        ...
        self.doubleSpinBox_pas.setEnabled(True)
