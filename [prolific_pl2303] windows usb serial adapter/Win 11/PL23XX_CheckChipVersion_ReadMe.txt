...
System Requirement:
  ...
  . Device using PL2303GC/GS/GB/GT/GL/GE/GR, PL2323 version chips
  ...
  . Supports the following Windows OS Family:
	...
	NOTE: 
	  ...
	  - Windows 11 is NOT supported in TA/TB chip versions (will show yellow mark Error Code 10).
	  - Windows 11 is supported only in following chip versions:
	      - PL2303HXD (HX Rev D)
